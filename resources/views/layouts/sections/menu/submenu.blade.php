...
<ul class="menu-sub">
    @if (isset($menu))
        @foreach ($menu as $submenu)
            ...
            @if($authService->checkAuthorize(\Illuminate\Support\Facades\Auth::user()->role_id, \App\Services\PermissionService::concatPermissions($submenu['parent'], $submenu['child'])))
